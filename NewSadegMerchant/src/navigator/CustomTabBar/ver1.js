...
const ITEM_TOP_PADDING = sizes.base
const ITEM_BOTTOM_PADDING = sizes.xl
const ICON_SIZE = sizes.lg
const DOT_SIZE = ICON_SIZE / 4
				...
				return (
					...
					>
						<BaseIcon 
							...
							size={ICON_SIZE}
						/>
						{isFocused && <View style={{ position: 'absolute', width: DOT_SIZE, height: DOT_SIZE, borderRadius: DOT_SIZE, backgroundColor: colors.green, bottom: sizes.xxs }} />}
					</TouchableOpacity>
				);
			})}
		</View>
